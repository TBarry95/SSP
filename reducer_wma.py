...
for key_value in csv.reader(sys.stdin):
    if key_value[0] != "DATE_TIME": # ensure skips line 1
        ...
        if len(sent_list3) == hours[0]+1: # for SMA3, collect 4 values, and average 1,2,3. Prediction  = 4th value
            weighted_ts3 = (sent_list3[2]*0.5)+(sent_list3[1]*0.3)+(sent_list3[0]*0.2)
        ...
        if len(sent_list5) == hours[1]+1:
            weighted_ts5 = (sent_list5[4]*0.3)+(sent_list5[3]*0.25)+(sent_list5[2]*0.2)+(sent_list5[1]*0.15)+(sent_list5[0]*0.1)
        ...
        if len(sent_list10) == hours[2]+1:
            weighted_ts101 = (sent_list10[9]*0.15)+(sent_list10[8]*0.15)+(sent_list10[7]*0.125)+(sent_list10[6]*0.125)+(sent_list10[5]*0.1)
            weighted_ts102 = (sent_list10[4]*0.1)+(sent_list10[3]*0.075)+(sent_list10[2]*0.075)+(sent_list10[1]*0.05)+(sent_list10[0]*0.05)
            weighted_ts10 = weighted_ts101+weighted_ts102
            wma_10 = weighted_ts10/hours[1]
